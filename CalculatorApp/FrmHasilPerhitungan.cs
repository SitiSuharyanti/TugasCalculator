...
namespace CalculatorApp
{
    public partial class FrmHasilPerhitungan : Form
    {
        ...
        private void FrmHasil_OnPerhitungan(int index, float a, float b)
        {
            ...
            if (index == 0)
            {
                lstHasil.Items.Add(string.Format("Hasil Penjumlahan {0} + {1} = {2}", a, b, cal.Penjumlahan(a, b)));
            }
            else if (index == 1)
            {
            ...
            {
                lstHasil.Items.Add(string.Format("Hasil Pembagian {0} / {1} = {2}", a, b, cal.Pembagian(a, b)));
            }
        }
